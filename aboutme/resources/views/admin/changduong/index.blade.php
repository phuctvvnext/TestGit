        ...
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    ...
                    <a href="{{route('admin.changduong.add')}}" class="addtop"><img src="/templates/admin/img/add.png" alt="" /> Thêm</a>
                </div>
                <div class="content table-responsive table-full-width">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 10px"><a href="">{{$phanloai}}</a></td>
                            
                            <td>
                                <a href="{{ route('admin.changduong.edit',$id)}}"><img src="/public/templates/admin/img/edit.gif" alt="" /> Sửa</a> &nbsp;||&nbsp;
                                <a href="{{route('admin.changduong.del',$id)}}"><img src="/public/templates/admin/img/del.gif" alt="" /> Xóa</a>
                            </td>
                        </tr>
                        @endforeach
