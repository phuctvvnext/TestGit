        ...
        <div class="col-md-12">
            <div class="card">
                <div class="header">
                    ...
                    <a href="{{route('admin.danhmuc.add')}}" class="addtop"><img src="/templates/admin/img/add.png" alt="" /> Thêm</a>
                </div>
                <div class="content table-responsive table-full-width">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.danhmuc.edit',$id) }}"><img src="/templates/admin/img/edit.gif" alt="" /> Sửa</a> &nbsp;||&nbsp;
                                <a href="{{route('admin.danhmuc.del',$id)}}"><img src="/templates/admin/img/del.gif" alt="" /> Xóa</a>
                            </td>
                        </tr>
                        @endforeach
